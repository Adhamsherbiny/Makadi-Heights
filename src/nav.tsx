...
import weather from "./assets/nav logo/weather.png";
import contact from "./assets/nav logo/contact.png";
import menu from "./assets/nav logo/menu.png";
import round from "./assets/nav logo/round.png";
import "./nav.css";
import "./App.css";
import "./homepage.css";
            ...
            <li>
              <div className="weather">
                ...
                <p className="weather-deg">
                  {Math.floor(data?.data["main"].temp - 273)}
                </p>
